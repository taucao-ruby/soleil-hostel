...
- `lockForUpdate()` / `withLock()` required for all booking write paths: create, confirm, cancel
...
- lockForUpdate() / withLock() is absent from any booking write path being modified
