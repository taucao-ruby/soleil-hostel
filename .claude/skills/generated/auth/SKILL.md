...
61 symbols | 19 files | Cohesion: 89%
...
| `frontend/src/features/auth/RegisterPage.tsx` | validateName, validateEmail, validatePassword, validatePasswordConfirmation, validate (+4) |
...
- **`setCsrfToken`** (Function) — `frontend/src/shared/utils/csrf.ts:34`
- **`clearCsrfToken`** (Function) — `frontend/src/shared/utils/csrf.ts:44`
