...
24 symbols | 5 files | Cohesion: 48%
...
| File | Symbols |
|------|---------|
| `backend/tests/Feature/Authorization/GateTest.php` | test_admin_gate_allows_admin, test_moderator_gate_allows_admin, test_manage_rooms_gate_allows_admin_only, test_gate_authorize_passes_for_authorized, test_gate_check_is_equivalent_to_allows (+5) |
