...
65 symbols | 19 files | Cohesion: 74%
...
| `backend/app/Services/BookingService.php` | forceDelete, getTrashedBookings, invalidateTrashedBookings |
...
- **`forceDelete`** (Method) — `backend/app/Services/BookingService.php:376`
...
| `normalizeDate` | Method | `backend/app/Services/RoomAvailabilityService.php` | 253 |
| `forceDelete` | Method | `backend/app/Services/BookingService.php` | 376 |
| `getTrashedBookings` | Method | `backend/app/Services/BookingService.php` | 408 |
| `invalidateTrashedBookings` | Method | `backend/app/Services/BookingService.php` | 455 |
