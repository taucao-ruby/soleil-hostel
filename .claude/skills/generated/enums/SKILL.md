---
name: enums
description: "Skill for the Enums area of soleil-hostel. 26 symbols across 13 files."
---

# Enums

26 symbols | 13 files | Cohesion: 76%

## When to Use

- Working with code in `backend/`
- Understanding how UserResource, expected, transitionTo work
...
| `backend/app/Enums/BookingStatus.php` | isCancellable, label, isTerminal, isRefundInProgress |
...
| `backend/app/Services/CancellationService.php` | isRefundable |
| `backend/app/Models/Booking.php` | isRefundable |
| `backend/app/Http/Resources/UserResource.php` | UserResource |
...
| `isRefundable` | Method | `backend/app/Services/CancellationService.php` | 156 |
| `isRefundable` | Method | `backend/app/Models/Booking.php` | 133 |
| `isCancellable` | Method | `backend/app/Enums/BookingStatus.php` | 27 |
| `label` | Method | `backend/app/Enums/BookingStatus.php` | 93 |
| `toArray` | Method | `backend/app/Http/Resources/BookingResource.php` | 15 |
...
| Flow | Type | Steps |
|------|------|-------|
| `Cancel → IsCancellable` | cross_community | 4 |
...
1. `soleil-ai-review-engine_context({name: "UserResource"})` — see callers and callees
