...
35 symbols | 17 files | Cohesion: 73%
...
| File | Symbols |
|------|---------|
| `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | handle, handleCreated, handleUpdated, handleDeleted, handleCancelled (+1) |
...
| `invalidateUserBookings` | Method | `backend/app/Services/BookingService.php` | 249 |
| `invalidateBooking` | Method | `backend/app/Services/BookingService.php` | 259 |
| `handle` | Method | `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | 21 |
| `handleCreated` | Method | `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | 40 |
| `handleUpdated` | Method | `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | 48 |
| `handleDeleted` | Method | `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | 62 |
| `handleCancelled` | Method | `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | 70 |
| `handleRestored` | Method | `backend/app/Listeners/InvalidateCacheOnBookingChange.php` | 80 |
