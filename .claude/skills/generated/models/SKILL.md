...
| `handle` | Method | `backend/app/Http/Middleware/CheckHttpOnlyTokenValid.php` | 31 |
| `generateDeviceFingerprint` | Method | `backend/app/Http/Middleware/CheckHttpOnlyTokenValid.php` | 133 |
