...
| File | Symbols |
|------|---------|
| `backend/tests/Feature/Room/RoomAuthorizationTest.php` | test_user_can_access_rooms_show, test_user_cannot_delete_room, test_admin_can_delete_room, test_guest_can_access_rooms_index, test_user_can_access_rooms_index (+19) |
