---
name: room
description: "Skill for the Room area of soleil-hostel. 100 symbols across 22 files."
---

# Room

100 symbols | 22 files | Cohesion: 82%
...
| `backend/database/factories/BookingFactory.php` | forDays, cancelledByAdmin, multiDay |
...
| `it_returns_all_rooms_without_location_filter` | Method | `backend/tests/Feature/LocationApiTest.php` | 245 |
