...
>
> **Relocated 2026-06-15** from `docs/frontend/` to `docs/ops/` (restructure Batch 5b) — this
> is the full-stack production **configuration reference** (both Dockerfiles, nginx, env,
> CI/CD, monitoring, backup, security, performance). Related deploy docs, distinct by altitude:
> step-by-step procedure → `docs/backend/DEPLOYMENT.md` (runbook); local/dev Docker Compose →
> `docs/backend/guides/DEPLOYMENT.md` (compose guide); frontend build specifics →
